            ...
            carts.map((item:any)=>{
                ...
                return(
                    <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                        <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={node?.featuredImage?.url} alt="" />
                        <div className="flex w-full flex-col px-4 py-4">
                            <span className="font-semibold">{node.title}</span>
                            <p className="text-lg font-bold">${getPrice(node?.variants)}</p>
                        </div>
                    </div>
                )
            })
      ...
      <form className="mt-5 grid gap-6">
        <div className="relative">
          ...
          <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_1">
            <img className="w-14 object-contain" src={"https://www.servientrega.com/wps/wcm/connect/b6664ff1-636f-4c43-9f20-7c56a660529d/logo-vertical-fondo.png?MOD=AJPERES&CACHEID=ROOTWORKSPACE-b6664ff1-636f-4c43-9f20-7c56a660529d-nM1e-G4"} alt="" />
            <div className="ml-5">
              <span className="mt-2 font-semibold">Servientrega</span>
        ...
        <div className="relative">
          ...
          <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_2">
            <img className="w-14 object-contain" src={"https://envioyrastreo.com/wp-content/uploads/2024/03/Logo-interrapidisimo.webp"} alt="" />
            <div className="ml-5">
              <span className="mt-2 font-semibold">Rapidisimo</span>
              <p className="text-slate-500 text-sm leading-6">Entrega: 2-4 Dias</p>
            </div>
          </label>
        </div>

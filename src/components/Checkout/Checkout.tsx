...
import carritoVacio from '../../assets/carro-vacio.png';
...
export const Checkout = ({ carts = [] }: CheckoutProps) => {
  ...
  const calculateSubtotal = () => {
    return carts.reduce((acc, item) => acc + getPrice(item.node?.variants), 0);
  };
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          ...
          <p className="text-gray-400">
            Revisa lo que seleccionaste. Y seleccione un método de envío
            adecuado.
          </p>
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  src={
                    "https://www.servientrega.com/wps/wcm/connect/b6664ff1-636f-4c43-9f20-7c56a660529d/logo-vertical-fondo.png?MOD=AJPERES&CACHEID=ROOTWORKSPACE-b6664ff1-636f-4c43-9f20-7c56a660529d-nM1e-G4"
                  }
                  alt=""
                />
                <div className="ml-5">
            ...
            <div className="relative">
              ...
              >
                <img
                  className="w-14 object-contain"
                  src={
                    "https://envioyrastreo.com/wp-content/uploads/2024/03/Logo-interrapidisimo.webp"
                  }
                  alt=""
                />
                <div className="ml-5">
